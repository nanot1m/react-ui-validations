...
module.exports = function(storybookBaseConfig, configType) {
    ...
    storybookBaseConfig.module.loaders.push([
        ...
        },
        {
            ...
            include: /retail-ui/,
            exclude: /retail-ui(\\|\/)node_modules/,
            loader: 'style-loader!css-loader?localIdentName=[name]-[local]-[hash:base64:4]!less-loader',
        },
        {
            test: /\.(woff|woff2|eot|svg|ttf|gif|png)$/,
    ...
    storybookBaseConfig.resolve.modulesDirectories = ['node_modules', 'local_modules', 'web_modules'];
